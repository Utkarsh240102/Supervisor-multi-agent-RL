...
"""
    ...
    with open('sumo_files_multiagent/multiagent.nod.xml', 'w') as f:
        f.write(nodes_xml)
...
"""
    ...
    with open('sumo_files_multiagent/multiagent.edg.xml', 'w') as f:
        f.write(edges_xml)
...
"""
    ...
    with open('sumo_files_multiagent/multiagent.tls.xml', 'w') as f:
        f.write(tls_xml)
...
"""
    ...
    with open('sumo_files_multiagent/multiagent.rou.xml', 'w') as f:
        f.write(routes_xml)
...
"""
    ...
    with open('sumo_files_multiagent/multiagent.sumocfg', 'w') as f:
        f.write(cfg_xml)
...
def generate_all():
    ...
    # Create directory
    os.makedirs('sumo_files_multiagent', exist_ok=True)
